                ...
                .then(popularTools => {
                    ...
                    popularToolsDropdowns.forEach(dropdown => {
                        ...
                        if (viewAllLink) {
                            ...
                            newViewAll.innerHTML = '<a href="popular-tools.html">View All</a>';
                ...
                .then(categories => {
                    ...
                    allToolsDropdowns.forEach(dropdown => {
                        ...
                        if (viewAllLink) {
                            ...
                            const newViewAll = document.createElement('div');
                            newViewAll.className = 'view-all';
                            newViewAll.innerHTML = '<a href="all-tools.html">View All</a>';
                            dropdown.appendChild(newViewAll);
                        }
                    });
                })
            ...
            .then(popularTools => {
                ...
                window.toolsDataModule.getAllCategories()
                    .then(categories => {
                        ...
                        categories.forEach(category => {
                            html += `
                                <a href="all-tools.html?category=${encodeURIComponent(category)}" class="search-result-item">
                                    <div class="search-result-info">
